...
public class Solicitudes {
	...
	public DataSolicitud buscarSolicitudRefaccionVersion2016(Transaccion t, int idSolicitud) throws PersistenciaException {
		DataSolicitud dataSolicitud = null;
		...
		try {
			...
			if (rs.next()) {
				...
				dataSolicitud = new DataSolicitud(idSolicitud,fecha, estado, aportante, refaccion, puntaje);
			}
